...
If the trained model will have perfect input values, the output is expected to be within~1 \% miss accuracy.
\begin{figure}[htbp]
    \centering
    % DST based tests
...
Even though the accuracy with tabled samples has decreased, its feed-forward prediction accuracy has a significant increase.
\begin{figure}[htbp]
    \centering
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
