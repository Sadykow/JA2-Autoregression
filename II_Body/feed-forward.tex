...
\ifthenelse{\boolean{thesis}}{
    ...
    \begin{figure*}[!t]
        ...
        \caption{Comparison between training and testing accuracies of a 4-featured based LSTM model with a default training and testing loop on FUDS dataset. Note that the error area fill has been removed from both plots due to an extremely large error in (b).}
        \label{fig:regular_tr}
    \end{figure*}
}
%
