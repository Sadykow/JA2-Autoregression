...
Due to the size of the windows, equivalent to 8 and a quarter minutes of a discharge process, with only 1 sample shift \textit{s} between each other, no batching mechanism has been used to reduce computational load and avoid 4-dimensional matrix management.
