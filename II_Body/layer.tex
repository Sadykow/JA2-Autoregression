...
\begin{landscape}
    \begin{figure}[t]
        ...
        \caption{Data Windowing scheme at 1Hz sampling rate. For visualisation purposes, the $s$ shift has been used as 250 seconds, which is different from the actual implementation. The initial index $i$ was kept as a value close to the beginning of the data, around zero, \textcolor{blue}{excluding possible initial data discrepancies}.}
        \label{fig:Windowing}
    \end{figure}
\end{landscape}