...
\textcolor{blue}{In this work, the data set has four features, namely current, voltage, temperature and State of Charge, and an output parameter of SoC (i.e the next SoC imediately following the window set.)
