...
Subsection~\ref{subsec:lstm} present the type, structure and method of the Time-series model, which will be utilised throughout the research, along with input and output data management and optimisation strategy.
