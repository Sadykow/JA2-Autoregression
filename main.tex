...
\author{Marat~Sadykov, %~\IEEEmembership{Member,~IEEE,}
        ...
        Geoffrey Walker,~\IEEEmembership{Senior Member,~IEEE,}
...
% \textcolor{blue}{Matt: Do we need to put an outline of the next subsections or turn in in brief summary of what's to come, similar to Results?}
...
%! New page to free some space for extra lines
% \newpage
